        ...
        <div className="text-center">
          {block.url ? (
            <div className="inline-block">
              <img src={block.url} alt={block.caption || 'ছবি'} className="max-w-full max-h-56 mx-auto rounded-xl shadow-sm" />
...
function AddBlockMenu({ onAdd }: { onAdd: (type: ContentBlock['type']) => void }) {
  ...
  const types: ContentBlock['type'][] = ['heading', 'text', 'image', 'math', 'data', 'code', 'divider', 'pdf', 'link']
