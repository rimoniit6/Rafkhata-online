...
import { Eye, EyeOff, Printer, FileDown, Lock, ArrowLeft, BookOpen, ChevronDown, ChevronUp, CheckCircle2, Clock, Crown, Bookmark } from 'lucide-react'
...
export default function CQViewerPage() {
  ...
  useEffect(() => {
    ...
    fetchData()
  }, [params.cqId, params.chapterId, params.subjectId, params.classSlug])
