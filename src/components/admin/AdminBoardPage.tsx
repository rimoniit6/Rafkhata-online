                    ...
                    {form.type === 'mcq' && (
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          {form.questionImage && (
                            <img src={form.questionImage} alt="প্রশ্নের ছবি" className="mt-2 max-h-48 rounded border" />
                          )}
                        </div>
                              ...
                              >
                                <div className="flex items-start gap-2">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    {img && (
                                      <img src={img} alt={`অপশন ${labels[opt]}`} className="mt-1 max-h-32 rounded" />
                                    )}
                                  </div>
                                  {isCorrect && (
                        ...
                        {(form.explanation || form.explanationImage) && (
                          <div>
                            ...
                            {form.explanationImage && (
                              <img src={form.explanationImage} alt="ব্যাখ্যার ছবি" className="mt-2 max-h-48 rounded border" />
                            )}
                          </div>
                        )}
                      </div>
                    ...
                    {form.type === 'cq' && (
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          {form.uddeepokImage && (
                            <img src={form.uddeepokImage} alt="উদ্দীপকের ছবি" className="mt-2 max-h-48 rounded border" />
                          )}
                        </div>
                        ...
                        {([1, 2, 3, 4] as const).map((n) => {
                          ...
                          return (
                            <div key={n} className="border-l-4 border-l-teal-400 pl-4 space-y-2">
                              ...
                              {qImg && (
                                <img src={qImg} alt={`প্রশ্ন ${banglaNums[n]}`} className="mt-1 max-h-32 rounded" />
                              )}
                              {a && (
                                <>
                                  ...
                                  {aImg && (
                                    <img src={aImg} alt={`উত্তর ${banglaNums[n]}`} className="mt-1 max-h-32 rounded" />
                                  )}
                                </>
                              )}
                            </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden sm:table-cell">বোর্ড</TableHead>
                <TableHead className="hidden sm:table-cell">সাল</TableHead>
                <TableHead className="hidden md:table-cell">ক্লাস</TableHead>
                <TableHead className="hidden lg:table-cell">বিষয়</TableHead>
                <TableHead className="hidden md:table-cell">কঠিনতা</TableHead>
                <TableHead className="hidden lg:table-cell">প্রিমিয়াম</TableHead>
                <TableHead className="w-20">অ্যাকশন</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {questions.map((q) => (
                <TableRow key={`${q.type}-${q.id}`}>
                  ...
                  <TableCell className="hidden sm:table-cell">
                    {q.board ? boardLabelMap[q.board] || q.board : '-'}
                  </TableCell>
                  <TableCell className="hidden sm:table-cell">
                    {q.year || '-'}
                  </TableCell>
                  <TableCell className="hidden md:table-cell">
                    {classLabelMap[q.classLevel] || q.classLevel}
                  </TableCell>
                  <TableCell className="hidden lg:table-cell">
                    {q.subject?.name || q.chapter?.subject?.name || '-'}
                  </TableCell>
                  <TableCell className="hidden md:table-cell">
                  ...
                  <TableCell>
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        ...
                        onClick={() => setDeleteInfo({ id: q.id, type: q.type })}
                      >
              ...
              {questions.length === 0 && (
                <TableRow>
                  ...
                  >
                    কোনো বোর্ড প্রশ্ন পাওয়া যায়নি
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
