...
export default function PremiumBanner() {
  ...
  const features = (config?.premiumFeatures && config.premiumFeatures.length > 0)
    ? config.premiumFeatures
    : ['প্রিমিয়াম লেকচার ও কোর্স', 'বিস্তারিত MCQ ব্যাখ্যা', 'সৃজনশীল প্রশ্নের সমাধান', 'বিশেষ সাজেশন ও গাইড', 'সকল বোর্ড প্রশ্ন সমাধান']
