...
export default function MCQExamPackageDetailPage() {
  ...
  // ─── Fetch Package Overview (detail + exam-set-status + retake requests in one request) ──
  ...
  // ─── Keyboard navigation (during the exam) ───
  useEffect(() => {
  ...
  // ─── Timer warning: alert the user in the final minute ───
  useEffect(() => {
    ...
    // Reset the one-shot flag if the clock is no longer in the danger zone
    // (e.g. after resuming a different set with more time remaining).
    if (timeRemaining > 60) {
                    ...
                    return (
                      ...
                      <div className="mt-4 flex justify-end">
                        <Button
                          ...
                          onClick={() =>
                            currentQuestion &&
                            toggleMarkForReview(currentQuestion.mcqId)
                          }
                        >
