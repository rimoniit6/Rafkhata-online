...
import { ArrowLeft, FileQuestion, GraduationCap, BookOpen, Tag, Power, Loader2, Save } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h2 className="text-xl font-bold">{editId ? 'এক্সাম প্যাকেজ সম্পাদনা' : 'নতুন এক্সাম প্যাকেজ'}</h2>
      ...
      <Card className="border-border/50 overflow-hidden">
        <div className="bg-gradient-to-r from-emerald-50/80 to-teal-50/80 dark:from-emerald-950/30 dark:to-teal-950/30 px-4 py-3 border-b border-border/30">
          <Label className="text-sm font-semibold flex items-center gap-2">
            <FileQuestion className="h-4 w-4 text-emerald-600" /> প্যাকেজের মৌলিক তথ্য
          </Label>
        </div>
        <CardContent className="p-4 space-y-4">
          <div className="space-y-2">
            <Label>শিরোনাম *</Label>
            <Input
              placeholder="যেমন: SSC গণিত মডেল টেস্ট"
              value={pkgTitle}
