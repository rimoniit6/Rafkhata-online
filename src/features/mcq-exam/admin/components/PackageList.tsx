...
import { Plus, Search, FileQuestion, GraduationCap, BookOpen, Users, Power, Edit, Trash2 } from 'lucide-react'
...
interface PackageListProps {
  ...
  onOpenCreate: () => void
  onOpenDetail: (pkg: MCQExamPackageRecord) => void
  onToggleActive: (pkg: MCQExamPackageRecord) => void
  onOpenEdit: (pkg: MCQExamPackageRecord) => void
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-bold flex items-center gap-2">
            <FileQuestion className="h-5 w-5 text-emerald-600" /> MCQ এক্সাম প্যাকেজ
          </h2>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-lg font-medium">কোনো এক্সাম প্যাকেজ পাওয়া যায়নি</p>
