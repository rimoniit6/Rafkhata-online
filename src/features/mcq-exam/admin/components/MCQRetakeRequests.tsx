...
import { ArrowLeft, RefreshCw, CheckCircle, XCircle, Clock, Loader2, User } from 'lucide-react'
...
import { MCQExamRetakeRequestRecord, MCQExamSetRecord } from '@/features/mcq-exam/types'
...
interface MCQRetakeRequestsProps {
  loading: boolean
  requests: MCQExamRetakeRequestRecord[]
