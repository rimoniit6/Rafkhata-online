...
import { ArrowLeft, Plus, FileQuestion, Trash2, ChevronUp, ChevronDown, BookOpen, Pencil, Edit, Save, X, Loader2, Eye } from 'lucide-react'
...
import { CQExamSetRecord, CQExamSetQuestionRecord } from '@/features/cq-exam/types'
...
export function CQQuestionManager({
  ...
  onEditQuestion, onRemoveQuestion, onMoveQuestion, onUpdateQuestionMarks
