...
import { apiResponse, withAdmin, parseIdsParam, withCsrf } from '@/lib/api-utils'
...
if ('error' in csrfCheck) return csrfCheck.error
    ...
    const { title, description, thumbnail, price, originalPrice, duration, durationLabel, classLevel, isActive, order } = body

    if (!title) {
      return apiResponse(null, 'শিরোনাম প্রদান করুন', 400)
    }
