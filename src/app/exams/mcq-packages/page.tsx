...
import MCQExamPackageListPage from '@/components/exam/MCQExamPackageListPage'
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const meta = await getServerPageMeta('mcq-exam-package-list')
