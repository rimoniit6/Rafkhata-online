...
import CQExamPackageDetailPage from '@/components/cq-exam/CQExamPackageDetailPage'
import { getServerPageMeta } from '@/lib/seo'

export const dynamic = 'force-dynamic'

export async function generateMetadata(): Promise<Metadata> {
  try {
    const meta = await getServerPageMeta('cq-exam-package-detail')
