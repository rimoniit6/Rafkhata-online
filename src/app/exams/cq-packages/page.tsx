...
import CQExamPackageListPage from '@/components/cq-exam/CQExamPackageListPage'
...
export async function generateMetadata(): Promise<Metadata> {
  try {
    const meta = await getServerPageMeta('cq-exam-package-list')
